package com.example.demoKeycloak.config.embeddedKeycloak;
...
import com.example.demoKeycloak.config.embeddedKeycloak.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	private void createPruebaRealm() {
		KeycloakSession session = getSessionFactory().create();
